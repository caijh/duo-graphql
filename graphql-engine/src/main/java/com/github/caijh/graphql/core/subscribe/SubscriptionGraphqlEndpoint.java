...
public class SubscriptionGraphqlEndpoint {
    ...
    public void onMessage(String graphqlQuery, Session session) {
        ...
        SubscriptionMessage subscriptionMessage = this.jsonService.toObject(graphqlQuery, SubscriptionMessage.class);
        ...
        GraphQL graphQL = this.graphqlInvocationConfigure.getGraphQL();
    ...
    private void init() {
        ...
        this.jsonService = applicationContext.getBean(JsonService.class);
        this.graphqlInvocationConfigure = applicationContext.getBean(GraphqlInvocationConfigure.class);
    }
