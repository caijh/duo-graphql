package com.github.caijh.graphql.dao;
...
import com.github.caijh.graphql.core.exceptions.BaseServiceException;
...
public class ArticleDao {
    ...
    public List<Article> getByIds(Set<Integer> articleIds, List<String> selections) {
        ...
        articleIds.forEach(articleId -> articleList.add(this.getById(articleId, selections)));
